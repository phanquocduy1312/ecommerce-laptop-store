...
let sql = '-- Sample data for san_pham (products) - 200 products\n';
...
for (let i = 1; i <= 200; i++) {
  ...
  sql += `(${i}, '${productName}', '${slug}', ${price}, ${discountPrice}, ${category.id}, '${date}', 'https://cdn.tgdd.vn/Products/Images/44/265523/itel-able-1s-n4020-71006300027-1-1.jpg', ${hot}, ${views}, 1, ${tinhChat}, NULL, NULL, NULL, NULL)`;
...
fs.writeFileSync('products_200.sql', sql);
console.log('Generated 200 products in products_200.sql');
